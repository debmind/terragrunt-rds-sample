variable "name" {
  ...
  type        = string
  default     = "bbu-test-rds-terragrunt"
}

variable "subnets" {
  description = "List of subnet IDs to use"
  type        = list(string)
  default     = ["subnet-0494bc34321053f3d", "subnet-09e2a7f94fe4c0722"]
}
